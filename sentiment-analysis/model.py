...
def main():
    ...
    data_dir = "data"
    train_data_file = '../input/twitter-data/training.1600000.processed.noemoticon.csv'
    test_data_file = '../input/twitter-data/testdata.manual.2009.06.14.csv'
    ...
    if not os.path.isfile(model_filename):
        ...
        train_dataset = pd.read_csv('../input/twitter-data/training.1600000.processed.noemoticon.csv', delimiter=',', nrows = 100000)
        train_dataset.columns = ["polarity", "id", "date", "query", "user", "text"]
    ...
    test_dataset = pd.read_csv('../input/twitter-data/testdata.manual.2009.06.14.csv')
    test_dataset.columns = ["polarity", "id", "date", "query", "user", "text"]
